 ...
 * @file LCD_Display.h
 *
 * @brief Header file for the LCD_Display driver.
 *
...
#include <stdio.h>
//MARIO BODY LCD 
static uint8_t mario_left_leg[8] = { 0x07, 0x07, 0x07, 0x00, 0x01, 0x03, 0x03, 0x01 };
static uint8_t mario_torso[8] = { 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x19, 0x00, 0x10 };
static uint8_t mario_right_leg[8] = { 0x1F, 0x1F, 0x1E, 0x16, 0x1E, 0x1E, 0x00, 0x00 };
static uint8_t mario_left_hat[8] = { 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x00 };
static uint8_t mario_middle_hat[8] = { 0x00, 0x0F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x0F };
static uint8_t mario_right_hat[8] = { 0x00, 0x00, 0x1C, 0x10, 0x1C, 0x1E, 0x1C, 0x18 };

//MARIO STAR
static uint8_t mario_star_left[8] = {  0x00,
  0x00,
  0x00,
  0x00,
  0x00,
  ...
  0x07,
  0x03};
static uint8_t mario_star_left_leg[8] = {  0x00,
  0x01,
  0x01,
  0x03,
  0x03,
  ...
  0x00,
  0x00 };
static uint8_t mario_star_middle[8] = { 0x04,
  0x04,
  0x0E,
  0x0E,
  0x1F,
  ...
  0x15,
  0x15};
static uint8_t mario_star_bottom_middle[8] = {0x1F,
  0x1F,
  0x1F,
  0x1B,
  0x11,
  ...
  0x00,
  0x00};
static uint8_t mario_star_right[8] = { 0x00,
  0x00,
  0x00,
  0x00,
  0x00,
  ...
  0x1C,
  0x18 };
static uint8_t mario_star_right_leg[8] = { 0x00,
  0x10,
  0x10,
  0x18,
  0x18,
...
static uint8_t up_arrow[8] = { 0x00, 0x04, 0x0E, 0x15, 0x04, 0x04, 0x04, 0x04 };
static uint8_t down_arrow[8] = { 0x04, 0x04, 0x04, 0x04, 0x04, 0x15, 0x0E, 0x04 };
static uint8_t left_arrow[8] = { 0x00, 0x04, 0x08, 0x1F, 0x08, 0x04, 0x00, 0x00 };
static uint8_t right_arrow[8] = { 0x00, 0x04, 0x02, 0x1F, 0x02, 0x04, 0x00, 0x00 };
static uint8_t heart_shape[8] = { 0x00, 0x00, 0x0A, 0x1F, 0x1F, 0x0E, 0x04, 0x00 };
...
enum Custom_Character_CGRAM_Locations
{
	...
	//STAR Not working due to limited CGRAM, could force into overwriting it -- 12/1/24  --  / 12/6/24 -- Unable to force.
	/*MARIO_STAR_LEFT_LOCATION = 0x08,
	MARIO_STAR_LEFT__LEG_LOCATION = 0x09,
	MARIO_STAR_MIDDLE_LOCATION = 0x0A,
	MARIO_STAR_BOTTOM_MIDDLE_LOCATION = 0x0B,
	MARIO_STAR_RIGHT_LOCATION = 0x0C,
	MARIO_STAR_RIGHT_LEG_LOCATION = 0x0D*/
};
...
//--------------MARIO BODY Header Functions---------------------
/**
 * @brief Displays the right portion of Mario's hat on the LCD.
 *
 * This function updates the LCD to show the right side of Mario's hat,
 * contributing to the overall Mario design.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays Mario's torso on the LCD.
 *
 * This function updates the LCD to show the torso of Mario,
 * contributing to the overall Mario design.
 *
 * @param None
 *
...
/**
 * @brief Displays Mario's left leg on the LCD.
 *
 * This function updates the LCD to show the left leg of Mario,
 * contributing to the overall Mario design.
 *
 * @param None
 *
...
/**
 * @brief Displays the middle portion of Mario's hat on the LCD.
 *
 * This function updates the LCD to show the central section of Mario's hat,
 * contributing to the overall Mario design.
 *
 * @param None
 *
...
/**
 * @brief Displays the left portion of Mario's hat on the LCD.
 *
 * This function updates the LCD to show the left side of Mario's hat,
 * contributing to the overall Mario design.
 *
 * @param None
 *
...
/**
 * @brief Displays Mario's right leg on the LCD.
 *
 * This function updates the LCD to show the right leg of Mario,
 * contributing to the overall Mario design.
 *
 * @param None
 *
...
/**
 * @brief Displays the complete Mario design on the LCD.
 *
 * This function updates the LCD to show the full image of Mario,
 * combining all previously displayed parts into a cohesive design.
 *
 * @param None
 *
 * @return None
...
//------------------MARIO STAR Header Functions -------------------------
/**
 * @brief Displays the left star portion of Mario's design on the LCD.
 *
 * This function updates the LCD to show the left side star portion of Mario's design.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays Mario's left leg with a star on the LCD.
 *
 * This function updates the LCD to show the left leg of Mario, decorated with a star.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays the middle star portion of Mario's design on the LCD.
 *
 * This function updates the LCD to show the middle section of Mario's design with a star.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays the bottom middle star portion of Mario's design on the LCD.
 *
 * This function updates the LCD to show the bottom middle section of Mario's design with a star.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays the right star portion of Mario's design on the LCD.
 *
 * This function updates the LCD to show the right side star portion of Mario's design.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays Mario's right leg with a star on the LCD.
 *
 * This function updates the LCD to show the right leg of Mario, decorated with a star.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Displays the complete Mario design with stars on the LCD.
 *
 * This function updates the LCD to show the full image of Mario, combining all star-decorated sections into a cohesive design.
 *
 * @param None
 *
 * @return None
